...
public class Design7form extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    int[] images = {R.drawable.d7s1,R.drawable.d7s2};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_design7form);
        ...
        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(Design7form.this,
        ...
        ArrayAdapter<String> myAdapter2 = new ArrayAdapter<String>(Design7form.this,
                android.R.layout.simple_spinner_dropdown_item, getResources().getStringArray(R.array.d7colorpattern));
        ...
        servicestxtv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(Design7form.this);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (check == true) {
                    ...
                    FirebaseFirestore.getInstance().collection("Form7").add(v).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                        @Override
