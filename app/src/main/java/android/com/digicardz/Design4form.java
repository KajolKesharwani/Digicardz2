...
public class Design4form extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    int[] images = {R.drawable.d4s1,R.drawable.d4s2,R.drawable.d4s3};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(Design4form.this,
        ...
        ArrayAdapter<String> myAdapter2 = new ArrayAdapter<String>(Design4form.this,
                android.R.layout.simple_spinner_dropdown_item, getResources().getStringArray(R.array.d4colorpattern));
        ...
        servicestxtv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(Design4form.this);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (check == true) {
                    ...
                    FirebaseFirestore.getInstance().collection("Form4").add(v).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                        @Override
