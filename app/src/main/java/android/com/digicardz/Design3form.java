...
public class Design3form extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    int[] images = {R.drawable.d3s1,R.drawable.d3s2,R.drawable.d3s3,R.drawable.d3s4};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_design3form);
        ...
        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(Design3form.this,
        ...
        ArrayAdapter<String> myAdapter2 = new ArrayAdapter<String>(Design3form.this,
                android.R.layout.simple_spinner_dropdown_item, getResources().getStringArray(R.array.d3colorpattern));
        ...
        servicestxtv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(Design3form.this);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (check == true) {
                    ...
                    FirebaseFirestore.getInstance().collection("Form3").add(v).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                        @Override
