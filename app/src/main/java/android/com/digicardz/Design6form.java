...
public class Design6form extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    int[] images = {R.drawable.d6s1,R.drawable.d6s2};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_design6form);
        ...
        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(Design6form.this,
        ...
        ArrayAdapter<String> myAdapter2 = new ArrayAdapter<String>(Design6form.this,
                android.R.layout.simple_spinner_dropdown_item, getResources().getStringArray(R.array.d6colorpattern));
        ...
        servicestxtv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(Design6form.this);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (check == true) {
                    ...
                    FirebaseFirestore.getInstance().collection("Form6").add(v).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                        @Override
